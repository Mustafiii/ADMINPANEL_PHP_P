...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="<?= !empty($_GET['id']) ? "venteModifier.php" : "venteAjouter.php" ?>" method="post">
                ...
                <label for="articleQuantite" style="display: inline;">Quantité disponible</label>
                ...
                <input type="number" name="prix" readonly id="prix" step="0.01">
        ...
        <div class="box">
            ...
            <?php
                $ventes = getvente(null);
                if (!empty($ventes)) {
                    foreach ($ventes as $key => $value) {
                        $dv = date_create($value['date_vente']);
                ?>
                    ...
                    <tr>
                        ...
                        <td><?= $value['prix'] ?></td>
                        <td><?= date_format($dv, "Y-m-d") ?></td>
                        <td>
                            <a href="venteRecu.php?id=<?= $value['id'] ?>"><i class="bx bxs-receipt"></i></a>
                            ...
                            <a onclick="venteAnnuler(<?= $value['id'] ?>, <?= $value['id_article'] ?>, <?= $value['quantite'] ?>)" style="color:red;"><i class='bx bxs-message-square-minus'></i></a>
                        </td>
                    </tr>
