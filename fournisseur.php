...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="<?= !empty($_GET['id']) ? "fournisseurModifier.php" : "fournisseurAjouter.php" ?>" method="post">
        ...
        <div class="box">
            ...
            <?php
                $fournisseurs = getfournisseur(null);
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="fournisseurSupprimer(<?= $value['id'] ?>)"><i class="bx bx-trash"></i></a>
                        </td>
                    </tr>
...
<script>
    function fournisseurSupprimer(id) {
        if (confirm("Voulez-vous vraiment supprimer ce fournisseur ?")) {
            window.location.href = "fournisseurSupprimer.php?id=" + id;
        }
    }
</script>
